...
public class Missile_GameManager : MonoBehaviour
{
    ...
    public float pauseTimerMax = 10f, pauseTimerCount;
    ...
    private void FixedUpdate()
    {
        ...
        if (emissileCount >= emissileMax)
        {
            ...
            if (pauseTimerCount > pauseTimerMax) 
            {
                ...
                {
                    spawnPlane = false;
                    Instantiate(plane, planeSpawn.transform.position, planeSpawn.transform.rotation);
                }
